...
export default function ProgramListItemCard({ courses, program, filterProgramCourses }: Props) {
  ...
  return (
    <div className="flex h-fit w-full flex-col pt-20" key={program.sys.id}>
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex">
          <div className="flex grow flex-col sm:w-fit md:flex-row">
            ...
            <span
              className="mx-1 my-auto inline-flex w-fit items-center rounded-full border border-gray-300 px-3 py-1 font-nexa text-xs font-black"
      ...
      <hr className="border-gray-200" style={{ marginTop: 16, marginBottom: 16 }} />
      <div>
