    ...
    <section className="relative w-full overflow-hidden bg-[#1a1a1a]">
      ...
      <div className="relative mx-auto flex w-full max-w-screen-xl flex-col px-4 pb-16 pt-10 md:px-20 md:pb-24 md:pt-14">
        ...
        <nav className="mb-6 hidden items-center gap-2 text-[13px] md:flex" aria-label="Breadcrumb">
          ...
          <span className="text-white/30">&gt;</span>
          <span className="font-proxima font-medium text-[#BA2E36]">{name}</span>
        </nav>
        ...
        <div className="mb-5 flex">
          <span className="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 font-proxima text-[13px] font-semibold text-white">
            <span className="h-2 w-2 rounded-full bg-[#BA2E36]" />
        ...
        <div className="flex flex-wrap items-center gap-3">
          <Link
            href="/enquiry"
            className="inline-flex items-center gap-2.5 rounded-lg bg-[#BA2E36] px-9 py-[18px] font-proxima text-[17px] font-semibold text-white transition hover:bg-[#a52830]"
          >
            Apply Now
          ...
          <a
            ...
            className="inline-flex items-center gap-2.5 rounded-lg bg-[#25D366] px-7 py-[18px] font-proxima text-[17px] font-medium text-white transition hover:bg-[#20bd5a]"
          >
