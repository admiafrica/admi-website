    ...
    <section className="w-full bg-gradient-to-br from-brand-red via-[#8B1A24] to-admi-black">
      <div className="mx-auto flex max-w-[1280px] flex-col items-center gap-8 px-6 py-16 md:px-8 md:py-[100px]">
        ...
        <div className="flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row">
          <Link
            href="/courses"
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-white px-10 py-[18px] font-proxima text-[15px] font-bold text-brand-red transition-colors hover:bg-white/90 sm:w-auto sm:text-[17px]"
          >
          ...
          <Link
            href="/contact"
            className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-brand-orange px-10 py-[18px] font-proxima text-[15px] font-bold text-white transition-colors hover:bg-[#e55a2f] sm:w-auto sm:text-[17px]"
          >
            Book an Open Day
