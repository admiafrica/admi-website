      ...
      <div className="flex w-full items-center py-2 font-nexa">
        ...
        {!hiddenCTA && (
          <button
            ...
            className="hidden h-11 cursor-pointer items-center justify-center rounded-[8px] border-none bg-[#BA2E36] px-6 font-proxima text-[15px] font-semibold text-white antialiased transition-colors hover:bg-[#a02630] lg:inline-flex"
          >
            Apply
          </button>
        )}
        ...
        <div className="flex w-fit items-center gap-3 lg:hidden">
          ...
          {!hiddenCTA && (
            <button
              type="button"
              onClick={() => router.push('/enquiry')}
              className="inline-flex h-10 cursor-pointer items-center justify-center rounded-[8px] border-none bg-[#BA2E36] px-5 font-proxima text-[14px] font-semibold text-white antialiased transition-colors hover:bg-[#a02630]"
            >
              Apply
            </button>
          )}
