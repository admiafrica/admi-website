  ...
  return (
    <MainLayout footerBgColor="#1a1a1a">
      ...
      <div className="w-full">
        {/* -- Hero -- */}
        <section className="bg-gradient-to-br from-[#0A1A18] via-[#050D0C] to-admi-black px-4 py-20 xl:px-20">
        ...
        <section className="bg-white px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            <div className="text-center">
              <p className="font-proxima text-[13px] font-bold uppercase tracking-[1.2px] text-brand-red">HYBRID STUDENT WORK</p>
              <h2 className="mt-2.5 font-proxima text-[42px] font-bold text-[#171717]">Featured Projects Across Online + Campus Learning</h2>
          ...
          <section key={section.title} style={{ backgroundColor: section.bg }} className="px-4 py-16 xl:px-20">
            <div className="mx-auto w-full max-w-screen-xl">
              <div className="flex items-center justify-between">
                ...
                <Link href="#" className="font-proxima text-[14px] font-bold text-brand-red">View All &rarr;</Link>
              </div>
        ...
        <section className="bg-[#0F0F0F] px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            <div className="text-center">
              <p className="font-proxima text-[13px] font-bold uppercase tracking-[1.2px] text-brand-red">STUDENT VOICES</p>
