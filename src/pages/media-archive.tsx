...
const PRESS_KIT_ITEMS = [
  {
    ...
    iconColor: '#BA2E36',
    title: 'Brand & Logos',
    description: 'Download the official ADMI logo in PNG and SVG formats, along with brand colour palettes and usage guidelines.',
  ...
  },
  {
    ...
    iconColor: '#0A3D3D',
    title: 'Fact Sheets',
    description: 'Key statistics, programme information, accreditation details, and institutional milestones at a glance.',
    ...
    <MainLayout footerBgColor="#1a1a1a">
      ...
      <div className="w-full bg-[#0A0A0A] px-4 py-20 xl:px-0">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="flex items-center gap-3">
            ...
            <p className="font-nexa text-[13px] uppercase tracking-[0.2em] text-[#08F6CF]">
              Media Archive
            </p>
          </div>
          <h1 className="pt-5 font-fraunces text-[36px] font-bold leading-[1.15] text-white sm:text-[48px]">
            Photos, Videos and Press Resources
          </h1>
          <p className="max-w-2xl pt-4 font-nexa text-[17px] leading-relaxed text-white/80">
            Browse our collection of campus photos, student work, event coverage, and downloadable
            press materials.
          </p>
        </div>
      </div>
            ...
            {GALLERY_ITEMS_ROW_1.map((item) => (
              ...
              >
                ...
                <div className="relative z-10 w-full p-6 sm:p-8">
                  ...
                  <h3 className="mt-3 font-fraunces text-[22px] font-bold leading-tight text-white sm:text-[26px]">
                    {item.title}
                  </h3>
                </div>
                {/* Hover overlay */}
      ...
      <div className="bg-[#F9F9F9] px-4 py-16 sm:px-10 lg:px-20 lg:py-20">
        <div className="mx-auto w-full max-w-screen-xl">
          <div className="flex items-center gap-3">
            ...
            <p className="font-nexa text-[13px] uppercase tracking-[0.2em] text-[#BA2E36]">
              Press Kit
            </p>
          </div>
          <h2 className="pt-4 font-fraunces text-[32px] font-bold leading-[1.15] text-[#171717] sm:text-[40px]">
            Download Press Resources
          </h2>
          <p className="max-w-2xl pt-3 font-nexa text-[16px] leading-relaxed text-[#555]">
            Access our brand assets, institutional fact sheets, and high-resolution photography for
            editorial and press use.
          </p>
            ...
            {PRESS_KIT_ITEMS.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mt-5 font-fraunces text-[20px] font-bold text-[#171717]">
                    {item.title}
                  </h3>
                  <p className="mt-2 flex-1 font-nexa text-[14px] leading-relaxed text-[#555]">
                    {item.description}
                  </p>
                  <button
      ...
      >
        <div className="mx-auto w-full max-w-screen-xl text-center">
          <h2 className="font-fraunces text-[32px] font-bold text-white sm:text-[40px]">
            Have a Media Enquiry?
          </h2>
          <p className="mx-auto max-w-xl pt-4 font-nexa text-[16px] leading-relaxed text-white/70">
            For press enquiries, interview requests, or high-resolution assets, our communications
