...
import { IconArrowRight, IconBriefcase, IconUsers, IconHeartHandshake, IconSpeakerphone } from '@tabler/icons-react'

import { MainLayout } from '@/layouts/v3/MainLayout'
import { PageSEO } from '@/components/shared/v3'
import type { AlumniStat, FeaturedAlumni, CompanyRow, NetworkBenefit } from '@/types/alumni'

/* ------------------------------------------------------------------ */
/*  Data                                                               */
/* ------------------------------------------------------------------ */

const STATS: AlumniStat[] = [
...
const FEATURED_ALUMNI: FeaturedAlumni[] = [
  {
    name: 'Grace Muthoni',
...
const NETWORK_BENEFITS: NetworkBenefit[] = [
  {
    icon: IconBriefcase,
    ...
    <MainLayout footerBgColor="#1a1a1a">
      ...
      <div className="w-full">
        ...
        <section className="relative h-[520px] overflow-hidden">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0A0A0A]/90 via-[#0A0A0A]/70 to-[#0A0A0A]/50" />
          <div
            className="relative z-10 mx-auto flex h-full w-full max-w-screen-xl flex-col justify-center px-4 xl:px-20"
            style={{ paddingTop: 120, paddingBottom: 80 }}
          >
            <span className="inline-flex w-fit items-center rounded-full bg-[#BA2E36] px-4 py-1.5 font-proxima text-[12px] font-bold uppercase tracking-[2px] text-white">
              OUR ALUMNI NETWORK
            </span>
            <h1 className="font-fraunces mt-6 max-w-[780px] text-[52px] font-bold leading-[1.1] tracking-tight text-white">
            ...
            {STATS.map((s, i) => (
              <div key={s.label} className="flex items-center">
                <div className="text-center">
                  <p className="font-fraunces text-[36px] font-bold text-[#BA2E36]">{s.value}</p>
        ...
        <section className="bg-white px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <h2 className="font-fraunces mt-6 text-[40px] font-bold leading-[1.15] text-[#171717]">
              ...
              {FEATURED_ALUMNI.map((alumni) => (
                <article key={alumni.name} className="overflow-hidden rounded-xl border border-[#E8E8E8] bg-white">
                  ...
                  <div className="px-6 pb-7 pt-6">
                    <h3 className="font-fraunces text-[24px] font-bold text-[#171717]">{alumni.name}</h3>
                    <p className="mt-1.5 font-proxima text-[14px] font-bold text-[#BA2E36]">{alumni.role}</p>
        ...
        <section className="bg-[#F9F9F9] px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl text-center">
            ...
            <h2 className="font-fraunces mt-6 text-[40px] font-bold text-[#171717]">
        ...
        <section className="bg-[#F9F9F9] px-4 pb-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <h2 className="font-fraunces mt-6 text-[36px] font-bold text-[#171717]">What You Get as an ADMI Alumnus</h2>
              ...
              {NETWORK_BENEFITS.map((benefit) => {
                ...
                return (
                  <article key={benefit.title} className="rounded-xl bg-white p-8">
                    <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[#BA2E361A]">
                      <Icon size={24} className="text-[#BA2E36]" />
                    </div>
                    <h3 className="font-fraunces mt-5 text-[22px] font-bold text-[#171717]">{benefit.title}</h3>
        ...
        <section className="border-t border-[#EEEEEE] bg-white px-4 py-20 xl:px-20">
          <div className="mx-auto flex w-full max-w-screen-xl flex-col items-center gap-12 lg:flex-row lg:items-start lg:gap-16">
            ...
            <div className="flex flex-col justify-center lg:py-8">
              <span className="font-fraunces text-[80px] leading-none text-[#BA2E36]">&ldquo;</span>
              <p className="font-fraunces -mt-8 text-[22px] font-medium leading-[1.5] text-[#333]">
        ...
        <section
          ...
          style={{ background: 'linear-gradient(135deg, #BA2E36 0%, #7A1520 50%, #3D0A10 100%)' }}
        >
          <div className="mx-auto w-full max-w-screen-xl text-center">
            <h2 className="font-fraunces mx-auto max-w-[600px] text-[40px] font-bold leading-[1.15]">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/enquiry"
                className="inline-flex items-center gap-2 rounded-xl bg-white px-7 py-3.5 font-proxima text-[15px] font-bold text-[#0A0A0A] transition hover:bg-white/90"
              >
                Join Alumni Network <IconArrowRight size={18} />
              </Link>
              <Link
                href="/contact"
                className="inline-flex items-center gap-2 rounded-xl border border-white/40 px-7 py-3.5 font-proxima text-[15px] font-bold text-white transition hover:bg-white hover:text-[#0A0A0A]"
              >
                Share Your Story
              </Link>
            </div>
