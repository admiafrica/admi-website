...
import { IconDownload, IconCheck, IconUsers } from '@tabler/icons-react'
...
const FALLBACK: FinancialPlanningPageData = {
  feeCards: [
    {
...
export const getStaticProps: GetStaticProps<{ page: FinancialPlanningPageData }> = async () => {
  let page = FALLBACK
  ...
  try {
    ...
    if (entry?.fields) {
      ...
      page = {
        ...
        paymentPlans: f.paymentPlans || FALLBACK.paymentPlans,
        scholarships: f.scholarships || FALLBACK.scholarships,
        faqItems: f.faqItems || FALLBACK.faqItems,
    ...
    console.error('[Financial Planning] CMS fetch failed, using fallback:', error)
  }
...
export default function FinancialPlanningPage({ page }: InferGetStaticPropsType<typeof getStaticProps>) {
    ...
    <MainLayout footerBgColor="#002A23" heroOverlap>
      ...
      <div className="w-full">
        ...
        <section className="w-full bg-admi-black">
          <div className="section-container">
            <div className="grid grid-cols-1 items-center gap-10 py-20 pt-28 md:grid-cols-2 md:py-28 md:pt-36">
              {/* Left */}
              <div>
                <p className="mb-4 font-proxima text-[13px] font-bold uppercase tracking-[3px] text-secondary">
                  Student Support / Financial Planning
                </p>
                <h1 className="font-proxima text-[36px] font-bold leading-[1.12] text-white md:text-[48px]">
                ...
                <div className="mt-8 flex flex-wrap gap-4">
                  <a
                    href="#fee-structures"
                    className="inline-flex items-center gap-2 rounded-lg bg-secondary px-6 py-3 font-proxima text-[15px] font-bold text-admi-black transition-opacity hover:opacity-90"
                  >
              ...
              <div className="hidden md:flex md:justify-end">
                <div className="relative h-[360px] w-[360px] overflow-hidden rounded-2xl bg-gradient-to-br from-[#0A3D3D] to-secondary/20">
                  <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 p-8 text-center">
                    <IconUsers size={48} className="text-secondary" />
                    <p className="font-proxima text-[22px] font-bold text-white">Plan Your Future</p>
        ...
        <section id="fee-structures" className="w-full scroll-mt-20 bg-white">
          <div className="section-container section-padding">
            <div className="mx-auto max-w-[720px] text-center">
              <p className="section-label text-brand-red">Fee Structures</p>
              <h2 className="font-proxima text-[36px] font-bold leading-[1.15] text-[#171717] md:text-[42px]">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 sm:grid-cols-2 xl:grid-cols-4">
              {feeCards.map((card: FeeCard) => (
                ...
                >
                  <h3 className="font-proxima text-[20px] font-bold text-[#171717]">{card.title}</h3>
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
              {paymentPlans.map((plan: PaymentPlan) => (
                ...
                >
                  ...
                  <h3 className="font-proxima text-[22px] font-bold text-[#171717]">{plan.title}</h3>
                  ...
                  <div className="mt-6">
                    <Link
                      href="/contact"
                      className="inline-flex items-center gap-1 font-proxima text-[14px] font-bold text-[#0A3D3D] underline decoration-[#0A3D3D]/30 underline-offset-4 transition-colors hover:text-secondary"
                    >
                      Learn more
                    </Link>
                  </div>
        ...
        <section className="w-full bg-white">
          <div className="section-container section-padding">
            <div className="mx-auto max-w-[720px] text-center">
              <p className="section-label text-brand-red">Financial Aid</p>
              <h2 className="font-proxima text-[36px] font-bold leading-[1.15] text-[#171717] md:text-[42px]">
            ...
            <div className="mt-12 grid grid-cols-1 gap-6 md:grid-cols-3">
              {scholarships.map((s: ScholarshipCMS) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {Icon && <Icon size={24} style={{ color: s.iconColor }} />}
                    </div>
                    <h3 className="mt-5 font-proxima text-[20px] font-bold text-[#171717]">{s.title}</h3>
                    ...
                    <div className="mt-6">
                      <Link
                        href="/contact"
                        className="inline-flex items-center gap-1 font-proxima text-[14px] font-bold underline decoration-[#171717]/20 underline-offset-4 transition-colors hover:text-brand-red"
        ...
        <section className="w-full bg-[#f9f9f9]">
          <div className="section-container section-padding">
            ...
            <div className="mx-auto mt-12 max-w-[840px] space-y-3">
              {faqItems.map((item: FinancialFaqItem) => (
        ...
        <section className="w-full bg-[#0A3D3D]">
          <div className="section-container section-padding text-center">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link
                href="/contact"
                className="inline-flex items-center rounded-lg bg-secondary px-6 py-3 font-proxima text-[15px] font-bold text-admi-black transition-opacity hover:opacity-90"
              >
                Book a Consultation
              </Link>
              <a
            ...
            <div className="mt-10">
              <Link
                ...
                className="font-proxima text-[15px] font-bold text-secondary transition-opacity hover:opacity-80"
              >
