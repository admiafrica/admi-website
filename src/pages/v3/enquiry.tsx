      ...
      <div className="h-[100vh] w-full bg-[#002A23] pt-16">
        ...
        <div className="relative z-10 mx-auto flex w-full max-w-screen-2xl flex-col px-4 sm:flex-row 2xl:px-0">
          <div className="sm:w-1/2">
            ...
            <Box mb={4}>
              <Title label="to building your" color="white" size="48px" />
            </Box>
            <Box mb={4}>
              <Title label="career with ADMI" color="white" size="48px" />
            </Box>
            <Box className="flex flex-row">
              ...
              <Box className="flex w-1/2 flex-col px-2">
                ...
                <Box className="flex flex-row justify-between" h={'100%'} w={'90%'}>
                  <Box className="flex w-[32%] items-center justify-center rounded-xl" bg={'#F1FE37'} h={'8em'} mr={16}>
