...
import { VIDEO_CATEGORIES, categorizeVideo, getCategoryStats, getCategoryInfo } from '@/utils/video-categorization'
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  try {
    ...
    if (category && typeof category === 'string') {
      const categoryVideos = cache.videos.filter((video) => categorizeVideo(video).includes(category))
