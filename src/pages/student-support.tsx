      ...
      <div className="w-full">
        ...
        <section className="bg-gradient-to-br from-[#0F2E2A] via-[#0A1F1D] to-[#091110] px-4 py-20 xl:px-20">
          <div className="mx-auto flex w-full max-w-screen-xl flex-col items-center gap-12 lg:flex-row lg:justify-between">
            <div className="max-w-[640px]">
              <p className="font-proxima text-[12px] font-bold uppercase tracking-[3px] text-secondary">STUDENT SUPPORT</p>
              ...
              <div className="mt-7 flex flex-wrap items-center gap-4">
                <Link href="/contact" className="inline-flex items-center gap-2 rounded-[10px] bg-brand-red px-7 py-3.5 font-proxima text-[15px] font-bold text-white transition hover:bg-[#a02730]">
                  Book an Advisor <IconArrowRight size={18} />
                </Link>
                <Link href="https://wa.me/254741132751" target="_blank" className="inline-flex items-center gap-2 rounded-[10px] border border-white/50 px-7 py-3.5 font-proxima text-[15px] font-bold text-white transition hover:bg-white/10">
                  <IconBrandWhatsapp size={18} /> Contact Support Desk
                </Link>
              </div>
            </div>
            <div className="h-[400px] w-full max-w-[500px] rounded-2xl bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1648301033733-44554c74ec50?auto=format&fit=crop&w=1080&q=80')" }} />
          </div>
        </section>
        ...
        <section className="bg-white px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <h2 className="mt-4 font-proxima text-[36px] font-bold text-[#171717]">Download Fee Structures by Programme</h2>
            ...
            <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
              {page.feeCards.map((card: FeeCard) => (
                <article key={card.title} className="flex flex-col rounded-2xl border border-[#E8E8E8] bg-white p-7">
                  <span className="inline-block self-start rounded-lg px-3.5 py-2 font-proxima text-[12px] font-bold" style={{ backgroundColor: card.badgeBg, color: card.badgeColor }}>{card.badge}</span>
                  ...
                  <Link href="/financial-planning" className="mt-6 flex items-center justify-center gap-2 rounded-lg py-3 font-proxima text-[14px] font-bold text-white transition hover:opacity-90" style={{ backgroundColor: card.btnBg }}>
        ...
        <section className="bg-[#F9F9F9] px-4 py-20 xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            <div className="text-center">
              <p className="font-proxima text-[12px] font-bold uppercase tracking-[3px] text-brand-red">HOW WE SUPPORT YOU</p>
              <h2 className="mt-3 font-proxima text-[36px] font-bold text-[#171717]">Dedicated Support for Every Aspect of Student Life</h2>
              ...
              {page.supportTabs.map((tab: SupportTabCMS) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`font-proxima text-[13px] font-bold ${activeTab === tab.key ? 'text-brand-red' : 'text-[#555]'}`}>
                      {tab.label}
                    </span>
                  </button>
                )
        ...
        {/* -- CTA -- */}
        <section className="bg-gradient-to-br from-brand-red via-[#8E2028] to-[#1A1A1A] px-4 py-24 text-center text-white xl:px-20">
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
              <Link href="/contact" className="inline-flex items-center gap-2 rounded-lg bg-white px-7 py-3.5 font-proxima text-[15px] font-bold text-admi-black transition hover:bg-white/90">
                Book an Advisor <IconArrowRight size={18} />
              </Link>
              <Link href="https://wa.me/254741132751" target="_blank" className="inline-flex items-center gap-2 rounded-lg border border-white/40 px-7 py-3.5 font-proxima text-[15px] font-bold text-white transition hover:bg-white hover:text-admi-black">
