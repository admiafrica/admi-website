...
export default function WorkWithUsPage() {
  return (
    <MainLayout footerBgColor="#1a1a1a">
      <PageSEO
        title="Work With Us"
        description="Join ADMI's award-winning faculty and team. Explore open positions in film, design, music production, and creative education in Nairobi, Kenya."
        keywords="ADMI careers, work at ADMI, creative education jobs, teaching jobs Nairobi, film lecturer, design instructor"
      />
      ...
      <div className="w-full">
        ...
        <div className="relative min-h-[520px] overflow-hidden bg-[url('https://images.unsplash.com/photo-1524178232363-1fb2b075b655?auto=format&fit=crop&w=1920&q=80')] bg-cover bg-center md:min-h-[580px]">
          ...
          <div className="relative z-10 mx-auto flex h-full min-h-[520px] w-full max-w-screen-xl flex-col justify-end px-4 pb-14 md:min-h-[580px] xl:px-0">
            <span className="mb-5 inline-block w-fit rounded-full bg-[#BA2E36] px-4 py-1.5 font-nexa text-[12px] font-bold uppercase tracking-[0.15em] text-white">
              Careers at ADMI
            </span>
            <h1 className="max-w-[800px] font-fraunces text-[36px] font-bold leading-[1.1] text-white md:text-[48px] lg:text-[52px]">
            ...
            <a
              href="#open-positions"
              className="mt-7 inline-flex w-fit items-center gap-2 rounded-lg bg-[#BA2E36] px-6 py-3 font-nexa text-[15px] font-bold text-white transition hover:bg-[#a02630]"
            >
              View Open Positions
        ...
        <div className="bg-[#F9F9F9] py-16 md:py-20">
          <div className="mx-auto w-full max-w-screen-xl px-4 xl:px-0">
            <p className="font-nexa text-[12px] font-bold uppercase tracking-[0.18em] text-[#BA2E36]">
              Award-Winning Faculty
            </p>
            <h2 className="pt-3 font-fraunces text-[34px] font-bold leading-[1.15] text-[#171717] md:text-[40px]">
            ...
            <div className="grid grid-cols-1 gap-6 pt-10 md:grid-cols-3">
              {faculty.map((member) => (
                ...
                >
                  ...
                  />
                  <div className="p-6">
                    <h3 className="font-fraunces text-[22px] font-bold text-[#171717]">
                      {member.name}
                    </h3>
                    <p className="pt-1 font-nexa text-[13px] font-bold uppercase tracking-[0.08em] text-[#BA2E36]">
                      {member.title}
                    </p>
        ...
        <div id="open-positions" className="bg-white py-16 md:py-20">
          <div className="mx-auto w-full max-w-screen-xl px-4 xl:px-0">
            ...
            <div className="flex flex-wrap items-center gap-3 pt-3">
              <h2 className="font-fraunces text-[34px] font-bold leading-[1.15] text-[#171717] md:text-[40px]">
                Join Our Team
              </h2>
              <span className="rounded-full bg-[#BA2E36]/10 px-3 py-1 font-nexa text-[13px] font-bold text-[#BA2E36]">
            ...
            <div className="mt-10 flex flex-col gap-4">
              {openings.map((role) => (
                <div
                  key={role.title}
                  className="group flex flex-col items-start justify-between gap-4 rounded-xl border border-[#E8E8E8] bg-white p-6 transition hover:border-[#BA2E36]/30 hover:shadow-md md:flex-row md:items-center"
                >
                  <div className="flex-1">
                    <h3 className="font-fraunces text-[22px] font-bold leading-tight text-[#171717] md:text-[24px]">
                      {role.title}
                    </h3>
                  ...
                  <div className="flex shrink-0 items-center">
                    <span className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#BA2E36] text-white transition group-hover:bg-[#a02630]">
        ...
        <div className="bg-[#0A0A0A] py-16 md:py-20">
          <div className="mx-auto w-full max-w-screen-xl px-4 xl:px-0">
            ...
            <h2 className="pt-3 font-fraunces text-[34px] font-bold leading-[1.15] text-white md:text-[40px]">
            ...
            <div className="grid grid-cols-1 gap-5 pt-10 md:grid-cols-2">
              {benefits.map((benefit) => {
                ...
                return (
                  ...
                  >
                    <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-[#BA2E36]/15">
                      <Icon size={24} stroke={1.8} className="text-[#BA2E36]" />
                    </div>
                    <h3 className="font-fraunces text-[22px] font-bold text-white">
                      {benefit.title}
                    </h3>
              ...
              {teamMembers.map((member) => (
                <div key={member.name} className="group text-center">
                  <div
                    ...
                    style={{ backgroundImage: `url(${member.image})` }}
                  />
                  <h3 className="pt-4 font-fraunces text-[18px] font-bold text-[#171717] md:text-[20px]">
                    {member.name}
                  </h3>
        ...
        {/* 6. CTA                                                       */}
        {/* ============================================================ */}
        <div className="bg-gradient-to-r from-[#BA2E36] to-[#5A0F16] px-4 py-16 text-white md:py-20 xl:px-0">
          <div className="mx-auto w-full max-w-screen-xl text-center">
            <h2 className="font-fraunces text-[36px] font-bold leading-[1.15] md:text-[44px]">
              Don&apos;t See Your Role?
            </h2>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-white px-6 py-3 font-nexa text-[15px] font-bold text-[#BA2E36] transition hover:bg-white/90"
              >
                Send Your CV
                <IconArrowRight size={18} stroke={2} />
              </a>
