...
const FilmProductionKisumuPage = () => {
  ...
  return (
    <>
      <PageSEO
        title="Film Production Course in Western - ADMI"
        description="Best Film Production course in kisumu, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
        canonical="https://admi.ac.ke/courses/film-production-kisumu"
        keywords="film-production, kisumu, course, training, kenya, admi"
      />
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          Film Production Course in Western
        </Title>

        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Film Production training in kisumu with industry experts and guaranteed job placement support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Film Production in kisumu?
              </Title>

              <List spacing="sm" size="sm">
                <List.Item>Industry-relevant curriculum designed for Western market</List.Item>
                ...
                <List.Item>90% job placement rate in kisumu and surrounding areas</List.Item>
