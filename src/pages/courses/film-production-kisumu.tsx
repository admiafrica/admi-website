...
const FilmProductionKisumuPage = () => {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'Film Production Course in Western',
    description:
      'Professional Film Production training in kisumu, Kenya. Learn industry-relevant skills with 90% job placement rate.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="East Africa's premier film school welcomes students from Kisumu and Western Kenya. All classes held at our state-of-the-art Nairobi campus with industry-leading facilities."
        canonical="https://admi.ac.ke/courses/film-production-kisumu"
        keywords="premier film school western kenya, top film school kisumu, leading film school kenya, film production kisumu, best film school western, film school kisumu, admi"
      />
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          Premier Film School in Western Kenya - Film Production Course
        </Title>

        <Text size="lg" ta="center" mb="xl" c="dimmed">
          East Africa&apos;s premier film school welcomes students from Kisumu and Western Kenya. All classes at our
          ...
          <Grid.Col span={{ base: 12, md: 8 }}>
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder mt="md">
              ...
              <Accordion>
                ...
                <Accordion.Item key={0} value={`faq-0`}>
                  <Accordion.Control>How does Kisumu's emerging tech scene benefit film production students?</Accordion.Control>
                  <Accordion.Panel>
                    <Text size="sm">Kisumu’s tech growth, especially in Milimani and Mamboleo, offers film students unique access to cutting-edge technology and collaboration with tech startups for digital storytelling and innovative content creation.</Text>
                  </Accordion.Panel>
                </Accordion.Item>
                <Accordion.Item key={1} value={`faq-1`}>
                  <Accordion.Control>Are there local film production or media companies in Kisumu for internship opportunities?</Accordion.Control>
                  <Accordion.Panel>
                    <Text size="sm">Yes, Kisumu hosts several media companies, including Lake Region Media, and a growing number of content creation startups, providing rich internship and practical experience opportunities for film production students.</Text>
                  </Accordion.Panel>
                </Accordion.Item>
              </Accordion>
            </Card>
        ...
        <Title order={2} mt="xl" mb="md">
          Film Production Job Market in kisumu
        </Title>
...
export default FilmProductionKisumuPage
