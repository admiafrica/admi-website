...
const EntertainmentBusinessNakuruPage = () => {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'Entertainment Business Course in Rift Valley',
    description:
      'Professional Entertainment Business training in nakuru, Kenya. Learn music business, event management, artist management, and entertainment law.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Entertainment Business course in nakuru, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          Entertainment Business Course in Rift Valley
        </Title>

        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Entertainment Business training in nakuru with industry experts and guaranteed job placement
          support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Entertainment Business in nakuru?
              </Title>
            ...
            <Card shadow="sm" padding="lg" radius="md" withBorder mt="md">
              ...
              <Accordion>
                <Accordion.Item key={0} value={'faq-0'}>
                  <Accordion.Control>
                    How does Nakuru's strategic location benefit my entertainment-business studies?
                  </Accordion.Control>
                  <Accordion.Panel>
                    <Text size="sm">
                      Studying in Nakuru places you at the crossroads of the Kenyan entertainment industry, with unique
                      access to both the Nairobi market and the untapped potential of Western Kenya. This positions you
                      perfectly for practical learning and networking within the industry's key areas.
                    </Text>
                  </Accordion.Panel>
                </Accordion.Item>
                <Accordion.Item key={1} value={'faq-1'}>
                  <Accordion.Control>
                    Are there local firms in Nakuru where I can intern or work after completing my course?
                  </Accordion.Control>
                  <Accordion.Panel>
                    <Text size="sm">
                      Absolutely. Nakuru is home to dynamic sectors including tourism businesses and local media houses
                      that are always on the lookout for fresh talent in event management, digital marketing, and
                      content production. The city's growth in digital events and influencer management also opens up
                      new career paths.
                    </Text>
                  </Accordion.Panel>
                </Accordion.Item>
        ...
        <Title order={2} mt="xl" mb="md">
          Entertainment Business Opportunities in nakuru
        </Title>
...
export default EntertainmentBusinessNakuruPage
