...
const VideoGameDevelopmentKisumuPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Video Game Development Course in Western',
    description:
      'Professional Video Game Development training in kisumu, Kenya. Create games with Unity, Unreal Engine, and modern game development tools.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Video Game Development course in kisumu, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          Video Game Development Course in Western
        </Title>

        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Video Game Development training in kisumu with industry experts and guaranteed job placement
          support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Video Game Development in kisumu?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          Video Game Development Opportunities in kisumu
        </Title>
...
export default VideoGameDevelopmentKisumuPage
