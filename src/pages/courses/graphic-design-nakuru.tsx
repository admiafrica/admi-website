  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Graphic Design course in nakuru, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
        canonical="https://admi.ac.ke/courses/graphic-design-nakuru"
        keywords="graphic-design, nakuru, course, training, kenya, admi"
      />
      ...
      <Container size="lg" py="xl">
        ...
        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Graphic Design training in nakuru with industry experts and guaranteed job placement support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Graphic Design in nakuru?
              </Title>
