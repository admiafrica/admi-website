...
const GraphicDesignNakuruPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Graphic Design Course in Rift Valley',
    description:
      'Professional Graphic Design training in nakuru, Kenya. Learn industry-relevant skills with 90% job placement rate.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Industry's best-kept secret for students from Nakuru. Learn from star teachers like Brian Omolo at our Nairobi campus. Over 90% employment rate."
        canonical="https://admi.ac.ke/courses/graphic-design-nakuru"
        keywords="best graphic design course kenya, graphic design school nakuru, brian omolo graphic design, top design school kenya, graphic design diploma kenya, admi"
      />
      ...
      <Container size="lg" py="xl">
        ...
        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Welcoming students from Nakuru to Kenya&apos;s best-kept secret. Learn from star teacher Brian Omolo at our
        ...
        <Title order={2} mt="xl" mb="md">
          Graphic Design Job Market in nakuru
        </Title>
...
export default GraphicDesignNakuruPage
