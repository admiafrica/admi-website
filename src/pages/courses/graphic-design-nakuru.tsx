...
export default function GraphicDesignNakuruPage() {
  return (
    <CourseCityTemplate
      seo={{
        title: "Kenya's Most Sought-After Graphic Design Course - ADMI",
        description:
          "Industry's best-kept secret for students from Nakuru. Learn from star teachers like Brian Omolo at our Nairobi campus. Over 90% employment rate.",
        canonical: 'https://admi.ac.ke/courses/graphic-design-nakuru',
        keywords:
          'best graphic design course kenya, graphic design school nakuru, brian omolo graphic design, top design school kenya, graphic design diploma kenya, admi'
      }}
      courseName="Graphic Design"
      city="Nakuru"
      pageTitle="Kenya's Most Sought-After Graphic Design Course"
      subtitle="Welcoming students from Nakuru to Kenya's best-kept secret. Learn from star teacher Brian Omolo at our Nairobi campus. Over 90% employment rate"
      ...
      highlights={[
        ...
        "💼 <strong>Guaranteed Success:</strong> Direct access to Kenya's top design studios"
      ]}
      ...
      jobMarketTitle="Graphic Design Job Market in nakuru"
      jobMarketText="nakuru is a growing hub for creative industries in Kenya. As Kenya's capital,000, the ADMI offers excellent opportunities for Graphic Design graduates. The creative sector in Rift Valley is expanding rapidly, creating numerous job opportunities for skilled professionals."
