...
const EntertainmentBusinessEldoretPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Entertainment Business Course in Rift Valley',
    description:
      'Professional Entertainment Business training in eldoret, Kenya. Learn music business, event management, artist management, and entertainment law.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Entertainment Business course in eldoret, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        ...
        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Entertainment Business training in eldoret with industry experts and guaranteed job placement
          support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Entertainment Business in eldoret?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          Entertainment Business Opportunities in eldoret
        </Title>
        ...
        <Text>
          ...
          from eldoret are welcome to join our comprehensive programs at our Nairobi campus located at 25 Kenyatta
          Avenue.
        </Text>
...
export default EntertainmentBusinessEldoretPage
