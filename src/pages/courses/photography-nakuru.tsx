...
const PhotographyNakuruPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Photography Course in Rift Valley',
    description:
      'Professional Photography training in nakuru, Kenya. Learn industry-relevant skills with 90% job placement rate.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Photography course in nakuru, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        ...
        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Photography training in nakuru with industry experts and guaranteed job placement support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Photography in nakuru?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          Photography Opportunities in nakuru
        </Title>

        <Text>
          nakuru is an important center in Rift Valley with growing opportunities in Kenya&apos;s creative and digital
          industries. ADMI&apos;s Photography program prepares you for the expanding job market. Students from nakuru
...
export default PhotographyNakuruPage
