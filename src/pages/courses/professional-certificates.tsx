          ...
          <div className="section-container flex flex-col items-center gap-5 pb-16 pt-28 md:pb-24 md:pt-36 lg:flex-row lg:items-center lg:gap-10">
            ...
            <div className="flex flex-1 flex-col">
              ...
              <div className="flex flex-wrap items-center gap-3">
                <Link
                  href="/enquiry"
                  className="inline-flex items-center rounded-lg bg-secondary px-9 py-[18px] font-proxima text-[17px] font-semibold text-[#0B0B0F] transition hover:bg-[#06d4b2]"
                >
                  Apply Now
                </Link>
                <Link
                  href="/enquiry"
                  className="inline-flex items-center rounded-lg border-2 border-[#057A65] bg-[#EEF9F7] px-9 py-[18px] font-proxima text-[17px] font-medium text-[#057A65] transition hover:bg-[#057A65] hover:text-white"
                >
                  Enquire Now
                </Link>
                <a
