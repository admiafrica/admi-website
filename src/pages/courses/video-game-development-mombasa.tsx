...
const VideoGameDevelopmentMombasaPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Video Game Development Course in Coast',
    description:
      'Professional Video Game Development training in mombasa, Kenya. Create games with Unity, Unreal Engine, and modern game development tools.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Video Game Development course in mombasa, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          Video Game Development Course in Coast
        </Title>

        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Video Game Development training in mombasa with industry experts and guaranteed job placement
          support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Video Game Development in mombasa?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          Video Game Development Opportunities in mombasa
        </Title>
...
export default VideoGameDevelopmentMombasaPage
