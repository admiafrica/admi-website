...
const MusicProductionNairobiPage = () => {
  const courseSchema = {
    '@context': 'https://schema.org',
    '@type': 'Course',
    name: 'Music Production Course in Nairobi',
    description:
      'Professional Music Production training in nairobi, Kenya. Learn industry-relevant skills with 90% job placement rate.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best Music Production course in nairobi, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        ...
        <Text size="lg" ta="center" mb="xl" c="dimmed">
          Professional Music Production training in nairobi with industry experts and guaranteed job placement support
        </Text>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose Music Production in nairobi?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          Music Production Opportunities in nairobi
        </Title>
...
export default MusicProductionNairobiPage
