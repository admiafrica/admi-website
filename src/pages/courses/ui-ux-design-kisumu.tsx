...
const UIUXDesignKisumuPage = () => {
  const courseSchema = {
    ...
    '@type': 'Course',
    name: 'UI/UX Design Course in Western',
    description:
      'Professional UI/UX Design training in kisumu, Kenya. Learn industry-relevant skills with 90% job placement rate.',
    provider: {
  ...
  return (
    <>
      <PageSEO
        ...
        description="Best UI/UX Design course in kisumu, Kenya. Professional training with industry experts, modern facilities, and guaranteed job placement support."
      ...
      <Container size="lg" py="xl">
        <Title order={1} ta="center" mb="md">
          UI/UX Design Course in Western
        </Title>
        ...
        <Grid>
          <Grid.Col span={{ base: 12, md: 8 }}>
            <Card shadow="sm" padding="lg" radius="md" withBorder>
              <Title order={2} mb="md">
                Why Choose UI/UX Design in kisumu?
              </Title>
        ...
        <Title order={2} mt="xl" mb="md">
          UI/UX Design Opportunities in kisumu
        </Title>

        <Text>
          kisumu is an important center in Western with growing opportunities in Kenya&apos;s creative and digital
          industries. ADMI&apos;s UI/UX Design program prepares you for the expanding job market. Students from kisumu
...
export default UIUXDesignKisumuPage
