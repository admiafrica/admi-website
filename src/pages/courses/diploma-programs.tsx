        ...
        <section className="w-full bg-white py-6 md:py-16">
          <div className="section-container flex flex-col items-center gap-5 lg:flex-row lg:items-center lg:gap-10">
            ...
            <div className="flex flex-1 flex-col">
              <span className="w-fit rounded-full bg-[#FFF0EE] px-4 py-1.5 text-[12px] font-semibold text-[#E85A4F]">
              ...
              <p className="mt-1 max-w-[560px] text-[14px] leading-[1.5] text-[#555555] md:text-[15px]">
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2.5 sm:gap-4">
                <Link
                  href="/enquiry"
                  className="inline-flex items-center rounded-lg bg-brand-red px-6 py-3 text-[15px] font-semibold text-white transition-colors hover:bg-[#a02830] sm:px-8 sm:text-[17px]"
                >
                  Apply Now
                </Link>
                <Link
                  href="/enquiry"
                  className="inline-flex items-center rounded-lg border-2 border-solid border-brand-red bg-[#FFF0F0] px-6 py-3 text-[15px] font-medium text-brand-red transition-colors hover:bg-brand-red hover:text-white sm:px-8 sm:text-[17px]"
                >
                  Enquire Now
                </Link>
                <a
