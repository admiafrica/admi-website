...
const RESIDENCES: Residence[] = [
  {
    name: 'Nairobi Student Residences',
    price: 'From KES 12,000/month',
    description:
      'Modern student housing in Nairobi CBD, 10 minutes from campus. Furnished rooms, shared kitchen, and study spaces.',
    image:
  ...
  },
  {
    ...
    description:
      'Safe, well-managed accommodation for female students. Walking distance to public transport.',
    image:
  ...
  },
  {
    ...
    description:
      'ADMI partners with vetted private hostels across Nairobi to offer affordable, quality housing options.',
    image:
    ...
    <MainLayout footerBgColor="#1a1a1a">
      ...
      <div className="w-full">
        ...
        <section className="relative h-[480px] w-full overflow-hidden">
          ...
          />
          {/* Dark overlay */}
          <div className="absolute inset-0 bg-[#0A0A0A]/73" />
          ...
          <div className="section-container relative z-10 flex h-full flex-col justify-center">
            <div className="max-w-[700px]">
              ...
              <p className="mt-5 max-w-[560px] font-proxima text-[18px] leading-[1.6] text-white/80">
                Comfortable living options near campus to help you focus on what matters most &mdash;
                your creative education.
              </p>
            </div>
          </div>
        </section>
              ...
              {RESIDENCES.map((residence) => (
                ...
                >
                  ...
                  <div className="flex flex-1 flex-col gap-4 p-7">
                    <h3 className="font-fraunces text-[24px] font-bold text-[#0A0A0A]">
                      {residence.name}
                    </h3>
                    <p className="font-proxima text-[16px] font-semibold text-[#BA2E36]">
                      {residence.price}
                    </p>
                    <p className="font-proxima text-[14px] leading-[1.7] text-[#555]">
            ...
            <div className="mx-auto mt-12 grid max-w-[960px] grid-cols-2 gap-6 sm:grid-cols-3">
              {AMENITIES.map(({ label, Icon }) => (
                ...
                >
                  ...
                  <span className="font-proxima text-[15px] font-semibold text-[#0A0A0A]">
                    {label}
                  </span>
                </div>
              ))}
            ...
            <div className="flex flex-col items-center gap-12 md:flex-row md:gap-16">
              ...
              <div className="flex flex-col gap-5">
                ...
                <p className="max-w-[440px] font-proxima text-[15px] leading-[1.7] text-[#555]">
                  ADMI&apos;s Caxton House campus is centrally located in Nairobi, with easy access
                  to public transport, restaurants, shopping, and entertainment. Partner residences
              ...
              {STEPS.map((step) => (
                ...
                >
                  ...
                  <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#0A3D3D]">
                    <span className="font-fraunces text-[24px] font-bold text-[#08F6CF]">
                      {step.number}
                    </span>
                  </div>
        ...
        <section className="w-full bg-[#0A3D3D]">
          <div className="section-container section-padding text-center">
            ...
            <p className="mx-auto mt-4 max-w-[600px] font-proxima text-[18px] leading-[1.6] text-white/80">
              Secure your spot in one of our partner residences and start your ADMI journey with
