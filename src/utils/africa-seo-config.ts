...
export const AFRICAN_REGIONS = ['East Africa', 'West Africa', 'Southern Africa', 'North Africa', 'Central Africa']
...
export const AFRICAN_SEO_KEYWORDS = [
  ...
  'distance learning Africa',
  'African students',
  'African universities',
  'higher education Africa',
  'creative institution Africa',
...
export const getAfricanCountryKeywords = (countryCode?: string) => {
  ...
  const regionCountries = AFRICAN_COUNTRIES.filter((c) => c.region === country.region).map((c) => c.name)
