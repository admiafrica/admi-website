    ...
    <MainLayout footerBgColor="white">
      ...
      <Box className="bg-[#0A1A18] px-4 py-16 text-white xl:px-0">
        <Box className="mx-auto w-full max-w-screen-xl">
          <p className="font-nexa text-[14px] uppercase tracking-[0.15em] text-[#B7D8CF]">/student-experience/studios</p>
          <h1 className="pt-4 font-fraunces text-[46px] font-bold">Studios</h1>
          <p className="max-w-[820px] pt-4 font-nexa text-[18px] text-white/85">Professional studio spaces that support course projects, portfolio outcomes, and collaborative production.</p>
        </Box>
      </Box>
      ...
      <Box className="mx-auto w-full max-w-screen-xl px-4 py-14 xl:px-0">
        <Box className="rounded-xl border border-[#E8E8E8] bg-white p-6">
          <h2 className="font-fraunces text-[34px] font-bold text-[#171717]">Studio Features</h2>
